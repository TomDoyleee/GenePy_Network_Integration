...
# DEPRECIATED 
def get_string_IDs(df, patientID):
    '''
    ...
    # import gene names
    gene_list = get_genes_above_zero(df, patientID)
...
def get_gene_phenotype(df, gene):
    '''
    function that retireves patient phenotype data from get_data.py and returns the phenotypes associated for that given gene.
    Parameters
    ----------
